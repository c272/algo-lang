...
public interface IalgoListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterStat_asyncFunctionCall([NotNull] algoParser.Stat_asyncFunctionCallContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="algoParser.stat_asyncFunctionCall"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitStat_asyncFunctionCall([NotNull] algoParser.Stat_asyncFunctionCallContext context);
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterStat_try_catch([NotNull] algoParser.Stat_try_catchContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="algoParser.stat_try_catch"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitStat_try_catch([NotNull] algoParser.Stat_try_catchContext context);

	/// <summary>
	/// Enter a parse tree produced by <see cref="algoParser.stat_throw"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterStat_throw([NotNull] algoParser.Stat_throwContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="algoParser.stat_throw"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitStat_throw([NotNull] algoParser.Stat_throwContext context);
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterStat_continue([NotNull] algoParser.Stat_continueContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="algoParser.stat_continue"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitStat_continue([NotNull] algoParser.Stat_continueContext context);
